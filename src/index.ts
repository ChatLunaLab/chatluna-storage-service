    ...
    Schema.union([
        ...
        Schema.object({
            ...
            s3SecretAccessKey: Schema.string()
                ...
                .role('secret')
                .required(),
            s3PublicUrl: Schema.string()
                .description('S3 公网访问 URL（可选，如果配置则直接返回公网 URL）'),
        ...
        Schema.object({
            ...
            webdavEndpoint: Schema.string()
                .description('WebDAV 服务器地址')
                .required(),
            webdavUsername: Schema.string()
            ...
            webdavBasePath: Schema.string()
                ...
                .default('chatluna-storage'),
            webdavPublicUrl: Schema.string()
                .description('WebDAV 公网访问 URL（可选）')
        }).description('WebDAV 配置'),

        Schema.object({
            storageBackend: Schema.const('r2').required(),
            r2AccountId: Schema.string()
                .description('Cloudflare 账户 ID')
                .required(),
            r2Bucket: Schema.string()
                .description('R2 存储桶名称')
                .required(),
            r2AccessKeyId: Schema.string()
            ...
            r2SecretAccessKey: Schema.string()
                ...
                .role('secret')
                .required(),
            r2PublicUrl: Schema.string()
                .description('R2 公网访问 URL（需在 Cloudflare 配置公共访问）')
